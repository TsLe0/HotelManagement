...
<html lang="vi">
 <head>
  ...
  <title>
   Chi tiết phòng ${roomType.roomTypeName}
  </title>
   ...
   <section class="mb-10">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
     <div class="md:col-span-2 rounded-lg overflow-hidden">
      <img alt="${roomType.roomTypeName}" class="w-full h-auto object-cover rounded-lg" height="450" src="${roomImages[0].roomImages}" width="800"/>
     </div>
     <div class="space-y-4">
      <c:forEach items="${roomImages}" var="i" begin="1">
      <img alt="${roomType.roomTypeName}" class="w-full h-auto object-cover rounded-lg" height="200" src="${i.roomImages}" width="400"/>
      </c:forEach>
     </div>
    </div>
   </section>
   <section class="mb-10 grid grid-cols-1 md:grid-cols-3 gap-8">
    <div class="md:col-span-2 bg-white rounded-lg shadow p-6">
     ...
     <ul class="space-y-3 text-gray-700">
      ...
      <li class="flex items-center">
       <i class="fas fa-coffee text-blue-600 w-6">
       </i>
       <span>
        Minibar và ấm đun nước điện
       </span>
      </li>
      <li class="flex items-center">
       <i class="fas fa-shower text-blue-600 w-6">
       </i>
       <span>
